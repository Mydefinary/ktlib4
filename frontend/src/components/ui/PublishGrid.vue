                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="LlmGpt">
                                <LlmGptId :editMode="editMode" v-model="val.llmGptId"></LlmGptId>
                            </td>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            ...
                            <String label="Genre" v-model="selectedRow.genre" :editMode="true"/>
